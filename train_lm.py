...
class TransformerLM(nn.Module):
  def __init__(self, vocab_size, embedding_dim, nhead, num_layers, dim_feedforward, sequence_length):
    ...
    self.transformer = nn.TransformerEncoder(encoder_layer=layer, num_layers=num_layers, enable_nested_tensor=False)
